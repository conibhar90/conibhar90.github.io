...
def playGame(wordList):
    ...
    while handChoice != 'e':
        ...
        handChoice = str(input("Enter n to deal a new hand, r to replay the last hand, or e to end game: "))
        
        while handChoice != 'r' or lastHand != {}:
        
            if handChoice == 'n' or 'r' or 'e':
                if handChoice == 'n':
                    hand = dealHand(n)
                ...
                elif handChoice == 'r' and lastHand != {}:
                    hand = lastHand
                    playHand(hand, wordList, n)
                    lastHand = hand
                    break
